...
<body>
    <form method="POST" enctype="multipart/form-data">
        ...
        <label>Nome</label>
        <input type="text" name="singername" placeholder="Nome" value="<?php echo $name; ?>"><br>
        <label>info</label>
        <textarea style=" margin: 0px; width: 360px; height: 164px; border: 2px solid #ccc; border-radius: 5px;" name="info" type="text" placeholder="Info"><?php echo $infoSinger; ?></textarea><br>
        ...
        <a href="editSinger.php" class="ca">Voltar</a>

        <button type="submit" name="submit">Mandar</button>
    </form>
</body>
