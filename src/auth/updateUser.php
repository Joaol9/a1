    ...
    <table align="center" border="2" style=" border-color:#fff ;width:600px; line-height:40px; color: white;">
        ...
        <?php foreach ($users as $index => $user) : ?>
            <tr>
                ...
                <td><a style="padding: 5px; background-color: #E3242B; color: #fff; border-radius: 15px; text-decoration: none;" href="delete.php?id=<?php echo $user['id'] ?>"><strong>Deletar</strong></a></td>
            </tr>
        <?php endforeach; ?>
    </table>
    <div class="message">
